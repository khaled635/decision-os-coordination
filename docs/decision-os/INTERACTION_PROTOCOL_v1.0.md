...
- محدودیت پیش‌فرض: حداکثر **۲ دور Challenge** برای هر `INTERACTION_ID`. رسیدن به دور سوم بدون
  تأیید صریح Human مجاز نیست؛ در آن نقطه بحث باید متوقف و به Human ارجاع شود (مطابق «شرایط توقف
  Challenge» در همین سند).
...
- محدودیت پیش‌فرض ۲ دور Challenge (رجوع به «قواعد دورهای Challenge») بدون تأیید صریح Human برای
  ادامه، پر شده باشد.
